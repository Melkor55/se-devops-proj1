## Disclaimer: the Dockerfile files are not present in this project but can be find by accessing the docker images(locally or directly on docker hub) used by the Web-App containers
